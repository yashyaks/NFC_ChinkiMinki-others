...
export default function Hero() {  
    return (
      <>
          ...
          {/*<Box sx={innerBoxStyles} backdropFilter='auto' backdropContrast='1%'>*/}
          ...
          <Stack
            ...
            <Heading
              ...
              <Text
                ...
                fontSize={{ base: '2xl', sm: '4xl', md: '6xl' }}
                >
                For your Half Baked Business Ideas
              </Text>


            <Text color={'white'} fontSize={'2xl'}>
            Where Ideas Take Flight: Your One-Stop Shop for Entrepreneurial Inspiration 
            </Text>
            <Stack
              direction={'column'}
              spacing={3}
